import{_ as n,o as a,c as p,at as e}from"./chunks/framework.CY22Hent.js";const l="/assets/20230721111245.DEyUdHvX.png",i="/assets/20230721112638.CCLK2vpt.png",g=JSON.parse('{"title":"浏览器的ERR_UNSAFE_PORT问题","description":"","frontmatter":{"title":"浏览器的ERR_UNSAFE_PORT问题","date":"2023-01-21T00:00:00.000Z","sidebar":"auto","categories":["随笔"]},"headers":[],"relativePath":"blogs/随笔/浏览器的ERR_UNSAFE_PORT问题.md","filePath":"blogs/随笔/浏览器的ERR_UNSAFE_PORT问题.md"}'),t={name:"blogs/随笔/浏览器的ERR_UNSAFE_PORT问题.md"};function c(o,s,r,d,h,_){return a(),p("div",null,[...s[0]||(s[0]=[e('<p>[toc]</p><h1 id="浏览器的err-unsafe-port问题" tabindex="-1">浏览器的ERR_UNSAFE_PORT问题 <a class="header-anchor" href="#浏览器的err-unsafe-port问题" aria-label="Permalink to &quot;浏览器的ERR_UNSAFE_PORT问题&quot;">​</a></h1><p><a href="https://zhuanlan.zhihu.com/p/383077079" target="_blank" rel="noreferrer">参考链接</a></p><p>浏览器在访问某些使用特殊端口(例如10080端口)的网站时，会出现无法访问的情况，错误代码为ERR_UNSAFE_PORT。</p><p><img src="'+l+`" alt="20230721111245.png" loading="lazy"></p><p>百度查询后发现是各家浏览器集体封杀了很多非安全端口。若访问这些端口就会出现这个错误。简而言之，这个问题和浏览器有关，和服务器没关系。</p><p>部分非安全端口</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>1,    // tcpmux</span></span>
