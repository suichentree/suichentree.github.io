import{_ as a,o as n,c as p,at as i}from"./chunks/framework.CY22Hent.js";const h=JSON.parse('{"title":"Git笔记","description":"","frontmatter":{"title":"Git笔记","date":"2021-03-12T00:00:00.000Z","sidebar":"auto","tags":["Git"]},"headers":[],"relativePath":"blogs/GIT/Git笔记.md","filePath":"blogs/GIT/Git笔记.md"}'),e={name:"blogs/GIT/Git笔记.md"};function l(t,s,c,o,g,r){return n(),p("div",null,[...s[0]||(s[0]=[i(`<p>[toc]</p><h2 id="git笔记" tabindex="-1">Git笔记 <a class="header-anchor" href="#git笔记" aria-label="Permalink to &quot;Git笔记&quot;">​</a></h2><p>Git是一个开源的分布式版本控制系统.</p><h3 id="_1-git安装与配置" tabindex="-1">1.Git安装与配置 <a class="header-anchor" href="#_1-git安装与配置" aria-label="Permalink to &quot;1.Git安装与配置&quot;">​</a></h3><p>当git安装完成后，在开始菜单里找到“Git”-&gt;“Git Bash”，蹦出一个类似命令行窗口的东西，就说明Git安装成功！ 在Git Bash中进行全局个人配置，配置你的git用户名和git邮箱</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>$ git config --global user.name &quot;Your Name&quot;</span></span>
