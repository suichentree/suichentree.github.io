import{_ as n,o as a,c as p,at as e}from"./chunks/framework.CY22Hent.js";const m=JSON.parse('{"title":"windows系统下开发环境启动脚本","description":"","frontmatter":{"title":"windows系统下开发环境启动脚本","date":"2023-03-07T00:00:00.000Z","lastUpdated":"2023-03-07T00:00:00.000Z","categories":["系统"],"tags":["windows"]},"headers":[],"relativePath":"blogs/Windows/windows系统下开发环境启动脚本.md","filePath":"blogs/Windows/windows系统下开发环境启动脚本.md"}'),i={name:"blogs/Windows/windows系统下开发环境启动脚本.md"};function l(t,s,c,o,d,r){return a(),p("div",null,[...s[0]||(s[0]=[e(`<p>[toc]</p><h2 id="windows系统下开发环境启动脚本" tabindex="-1">windows系统下开发环境启动脚本 <a class="header-anchor" href="#windows系统下开发环境启动脚本" aria-label="Permalink to &quot;windows系统下开发环境启动脚本&quot;">​</a></h2><p>使用场景：在windows系统下快速批量启动开发环境所需要的程序。</p><p>① 创建bat批处理文件，文件内容如下。</p><ul><li>批量运行nacos程序</li><li>批量运行nginx程序</li></ul><p>开发环境批量启动脚本.bat</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>:: 该脚本用于批量各种开发环境。例如nacos,nginx等</span></span>
