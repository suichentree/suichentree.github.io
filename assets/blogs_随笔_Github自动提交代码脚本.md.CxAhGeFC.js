import{_ as i,o as a,c as n,at as p}from"./chunks/framework.CY22Hent.js";const d=JSON.parse('{"title":"Github自动提交代码脚本","description":"","frontmatter":{"title":"Github自动提交代码脚本","date":"2023-08-08T00:00:00.000Z","sidebar":"auto","categories":["随笔"]},"headers":[],"relativePath":"blogs/随笔/Github自动提交代码脚本.md","filePath":"blogs/随笔/Github自动提交代码脚本.md"}'),l={name:"blogs/随笔/Github自动提交代码脚本.md"};function h(t,s,k,e,r,F){return a(),n("div",null,[...s[0]||(s[0]=[p(`<h1 id="github自动提交代码脚本" tabindex="-1">Github自动提交代码脚本 <a class="header-anchor" href="#github自动提交代码脚本" aria-label="Permalink to &quot;Github自动提交代码脚本&quot;">​</a></h1><p>该脚本用于自动提交代码到github的仓库上。主要分为几种情况。</p><h2 id="自动提交代码脚本给博客仓库" tabindex="-1">自动提交代码脚本给博客仓库 <a class="header-anchor" href="#自动提交代码脚本给博客仓库" aria-label="Permalink to &quot;自动提交代码脚本给博客仓库&quot;">​</a></h2><p>我的博客本质上是前端vuepress项目，博客仓库分为源代码仓库和博客页面仓库。一个存放源码，一个存放源码打包生成的静态页面。</p><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 该脚本主要分两个部分。</span></span>
