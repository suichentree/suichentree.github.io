import{_ as i,o as a,c as n,at as l}from"./chunks/framework.CY22Hent.js";const E=JSON.parse('{"title":"java运行shell脚本","description":"","frontmatter":{"title":"java运行shell脚本","date":"2023-01-09T00:00:00.000Z","sidebar":"auto","categories":["系统"],"tags":["Linux"]},"headers":[],"relativePath":"blogs/随笔/java运行脚本.md","filePath":"blogs/随笔/java运行脚本.md"}'),p={name:"blogs/随笔/java运行脚本.md"};function h(k,s,t,e,r,d){return a(),n("div",null,[...s[0]||(s[0]=[l(`<p>[toc]</p><h1 id="java运行shell脚本" tabindex="-1">java运行shell脚本 <a class="header-anchor" href="#java运行shell脚本" aria-label="Permalink to &quot;java运行shell脚本&quot;">​</a></h1><p>使用场景：</p><ul><li>用shell脚本，快速运行，停止，重启jar包。</li><li>用shell脚本，快速查询当天的日志。</li></ul><div class="language-shell vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#!/bin/sh   </span></span>
